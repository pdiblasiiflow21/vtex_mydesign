...
class OrdersTable extends Table
{
    ...
    {
        $validator
            ->scalar('order_id_vtex')
            ->maxLength('order_id_vtex', 255)
            ->requirePresence('order_id_vtex', 'create')
            ->notEmptyString('order_id_vtex')
            ->add('order_id_vtex', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->scalar('tracking_id')
            ->maxLength('tracking_id', 255)
            ->requirePresence('tracking_id', 'create')
            ->notEmptyString('tracking_id');
        ...
        $validator
            ->scalar('response_order_iflow')
            ->requirePresence('response_order_iflow', 'create')
            ->notEmptyString('response_order_iflow');

        $validator
            ->scalar('response_tracking_vtex')
            ->requirePresence('response_tracking_vtex', 'create')
            ->notEmptyString('response_tracking_vtex');
    ...
    {
        $rules->add($rules->isUnique(['order_id_vtex']), ['errorField' => 'order_id_vtex']);
